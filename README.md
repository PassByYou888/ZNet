...
**2026-3-31 完成delphi 13.1支持**

- 兼容性支持,内核无大更

**2025-2-19 新增2个FS3 demo**

- Demo采用win32 ui编写,服务直接放在内部便于演示(如果分开一个服务器一个客户端太麻烦),支持>1TB的大文件存储,支持无限文件数量
- 两个演示分别位于 Examples/170.FS3_Service_Demo, Examples/171.FS3_C4_Service_Demo
- FS3=File system 3.0,也就是C4 or VM框架的第三代文件系统,这是ZNet的高端技术体系产物
- FS3可以做服务器的服务器,例如1000个前端请求下载文件,FS3会生成1000个虚拟隧道让每个前端享受独立传输,而不是等待,排队
- FS3具有高流量冗余机制,即使TB级流量它也可以轻松应对
- 目前FS3已成为6代监控核心服务
...
- 更新 ZNet使用手册.pdf
- 在我集成到项目以后,我根据自己的项目修正OpCode非线性支持机制易用性
