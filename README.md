...
- **补充更新：安全阻塞**
- **补充更新：数据发送机制不再限制焦点主线程**，该更新对于安卓平台使用ZNet非常有用，试想一下：随便一个系统回调都是子线程，你的系统更新到11.2，用ZNet还要注意各种线程调度问题，**使用原则：仍以主线程为主，可以在线程偶尔用一下**
- **解决android平台因为编译器造成的arc问题**，编译器兼容xe11.2，fpc3.x
