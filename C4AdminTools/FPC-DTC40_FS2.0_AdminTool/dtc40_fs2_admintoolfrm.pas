...
begin
  ...
  FS_Info_Label.Caption := Format('Done connection. Max File size is %s for "%s" Service.', [umlSizeToStr(CurrentClient.MaxFileSize).Text, CurrentClient.ClientInfo.ServiceTyp.Text]);
end;
