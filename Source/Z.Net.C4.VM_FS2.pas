...
type
  ...
  TC40_VM_FS2_Service_File_Data_Pool = {$IFDEF FPC}specialize {$ENDIF FPC}TGenericHashList<TC40_VM_FS2_Service_File_Data>;
  TC40_VM_FS2_Service_MD5_Data_Pool = {$IFDEF FPC}specialize {$ENDIF FPC}TGenericHashList<TPascalStringList>;
