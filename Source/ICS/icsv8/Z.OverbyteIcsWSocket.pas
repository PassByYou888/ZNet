...
{$WARN UNIT_PLATFORM ON}
  ...
  Z.Ics.Posix.KEventTypes,
  Z.Ics.Posix.KEventApi,
...
{$IFNDEF NO_DEBUG_LOG}
  Z.OverbyteIcsLogger,
{$ENDIF}
  Z.OverbyteIcsUtils, Z.OverbyteIcsAvlTrees,
{$IFNDEF NO_HTTP_TUNNEL_AUTHDIGEST}
  Z.OverbyteIcsDigestAuth,
{$ENDIF}
{$IFDEF FMX}
  {$IF DEFINED(BUILTIN_THROTTLE) or DEFINED(BUILTIN_TIMEOUT)}
    Z.Ics.Fmx.OverbyteIcsThreadTimer,
  {$IFEND}
  Z.Ics.Fmx.OverbyteIcsWndControl,
{$ELSE FMX} // VCL
  {$IF DEFINED(BUILTIN_THROTTLE) or DEFINED(BUILTIN_TIMEOUT)}
    Z.OverbyteIcsThreadTimer,
  {$IFEND}
  Z.OverbyteIcsWndControl,
{$ENDIF FMX}
  Z.OverbyteIcsNtlmMsgs,
  Z.OverbyteIcsWSockBuf,
...
{$I Include\Z.Ics.InterlockedApi.inc}
...
begin
{$IFDEF MSWINDOWS}
    Z.OverbyteIcsWinsock.ForceLoadWinsock;
{$ENDIF}
(*
{$IFDEF MSWINDOWS}
...
begin
{$IFDEF MSWINDOWS}
    Z.OverbyteIcsWinsock.CancelForceLoadWinsock;
{$ENDIF}
(*
{$IFDEF MSWINDOWS}
    _EnterCriticalSection(GWSockCritSect);
...
begin
{$IFDEF MSWINDOWS}
    Z.OverbyteIcsWinsock.UnloadWinsock;
{$ENDIF}
end;
...
function WinsockInfo : TWSADATA;
begin
    Result := Z.OverbyteIcsWinsock.WinsockAPIInfo;
end;
