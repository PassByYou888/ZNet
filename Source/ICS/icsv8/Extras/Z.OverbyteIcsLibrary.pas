 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
unit Z.OverbyteIcsLibrary deprecated;
...
begin
  ...
  {$ENDIF}
  {$IFDEF POSIX}
    Result := Z.Ics.Posix.Messages.PostMessage(H, Msg, ParamW, ParamL)
  {$ENDIF}
end;
...
begin
  ...
  {$ENDIF}
  {$IFDEF POSIX}
    Result := Z.Ics.Posix.Messages.SendMessage(H, Msg, ParamW, ParamL)
  {$ENDIF}
end;
