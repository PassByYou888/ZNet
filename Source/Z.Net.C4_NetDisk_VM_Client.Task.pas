...
type
  ...
  public
    ...
    // stream
    function Add_Task_Post_Stream(Client: TC40_NetDisk_VM_Client; Stream: TCore_Stream; AutoFreeStream: Boolean; DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Post_Stream;
    function Add_Task_Get_Stream(Client: TC40_NetDisk_VM_Client; Stream: TCore_Stream; AutoFreeStream: Boolean; DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_Stream;
    function Add_Task_Get_Share_Stream(Client: TC40_NetDisk_VM_Client; Stream: TCore_Stream; AutoFreeStream: Boolean; Share_Directory_DB_Name, DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_Stream;
    // file
    function Add_Task_Post_File(Client: TC40_NetDisk_VM_Client; Local_File, DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Post_File;
    function Add_Task_Post_Directory(Client: TC40_NetDisk_VM_Client; Local_Directory, DB_Field: U_String): TC40_NetDisk_VM_Client_Task_Auto_Post_Directory;
    function Add_Task_Get_File(Client: TC40_NetDisk_VM_Client; Local_File, DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_File;
    function Add_Task_Get_Share_File(Client: TC40_NetDisk_VM_Client; Share_Directory_DB_Name, Local_File, DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_File;
    function Add_Task_Get_Directory(Client: TC40_NetDisk_VM_Client; Local_Directory, DB_Field: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_Directory;
    function Add_Task_Get_Share_Directory(Client: TC40_NetDisk_VM_Client; Share_Directory_DB_Name, Local_Directory, DB_Field: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_Directory;
  end;
...
constructor TC40_NetDisk_VM_Client_Task_Tool.Create;
begin
  inherited Create;
...
function TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Post_Stream(Client: TC40_NetDisk_VM_Client; Stream: TCore_Stream; AutoFreeStream: Boolean; DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Post_Stream;
var
...
function TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Get_Stream(Client: TC40_NetDisk_VM_Client; Stream: TCore_Stream; AutoFreeStream: Boolean; DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_Stream;
var
...
function TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Get_Share_Stream(Client: TC40_NetDisk_VM_Client; Stream: TCore_Stream; AutoFreeStream: Boolean; Share_Directory_DB_Name, DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_Stream;
var
  task_: TC40_NetDisk_VM_Client_Task_Auto_Get_Stream;
begin
  task_ := TC40_NetDisk_VM_Client_Task_Auto_Get_Stream.Create;
...
function TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Post_File(Client: TC40_NetDisk_VM_Client; Local_File, DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Post_File;
var
...
function TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Post_Directory(Client: TC40_NetDisk_VM_Client; Local_Directory, DB_Field: U_String): TC40_NetDisk_VM_Client_Task_Auto_Post_Directory;
var
...
function TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Get_File(Client: TC40_NetDisk_VM_Client; Local_File, DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_File;
var
...
function TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Get_Share_File(Client: TC40_NetDisk_VM_Client; Share_Directory_DB_Name, Local_File, DB_Field, DB_Item: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_File;
var
  task_: TC40_NetDisk_VM_Client_Task_Auto_Get_File;
begin
  task_ := TC40_NetDisk_VM_Client_Task_Auto_Get_File.Create;
...
function TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Get_Directory(Client: TC40_NetDisk_VM_Client; Local_Directory, DB_Field: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_Directory;
var
...
function TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Get_Share_Directory(Client: TC40_NetDisk_VM_Client; Share_Directory_DB_Name, Local_Directory, DB_Field: U_String): TC40_NetDisk_VM_Client_Task_Auto_Get_Directory;
var
  task_: TC40_NetDisk_VM_Client_Task_Auto_Get_Directory;
begin
  task_ := TC40_NetDisk_VM_Client_Task_Auto_Get_Directory.Create;
...
procedure TC40_NetDisk_VM_Client_Task_Auto_Post_Stream.Do_Usr_Auto_Post_File(sender: TC40_NetDisk_VM_Client; UserData: TCore_Object; Stream: TCore_Stream; Successed: Boolean; info: U_String);
begin
  Go_Next_Task;
end;
...
procedure TC40_NetDisk_VM_Client_Task_Auto_Get_Stream.Do_Usr_Auto_Get_File(sender: TC40_NetDisk_VM_Client; UserData: TCore_Object; Stream: TCore_Stream; Successed: Boolean; info: U_String);
begin
  Go_Next_Task;
end;
...
begin
  ...
  Local_Directory := '';
  DB_Field := '';
  Post_Directory_Task_Pool := TC40_NetDisk_VM_Client_Task_Tool.Create;
