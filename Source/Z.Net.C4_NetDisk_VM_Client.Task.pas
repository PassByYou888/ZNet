...
type
  ...
  TC40_NetDisk_VM_Client_Task_Event = procedure(sender: TC40_NetDisk_VM_Client_Task_Tool) of object;
  ...
  public
    ...
    On_All_Done: TC40_NetDisk_VM_Client_Task_Event;
    constructor Create;
...
procedure TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Post_Directory(Client: TC40_NetDisk_VM_Client; Local_Directory, DB_Field: U_String);
var
...
procedure TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Get_File(Client: TC40_NetDisk_VM_Client; Local_File, DB_Field, DB_Item: U_String);
var
...
procedure TC40_NetDisk_VM_Client_Task_Tool.Add_Task_Get_Directory(Client: TC40_NetDisk_VM_Client; Local_Directory, DB_Field: U_String);
var
...
procedure TC40_NetDisk_VM_Client_Task_Auto_Get_Directory.Run_Task;
begin
  if Share_Directory_DB_Name <> '' then
...
procedure TC40_NetDisk_VM_Client_Task_Auto_Post_Directory.Run_Task;
