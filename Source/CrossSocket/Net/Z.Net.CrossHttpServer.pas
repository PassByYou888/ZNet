...
uses
  ...
  Z.Net.CrossSslServer,
  {$ENDIF}
  Z.Net.CrossHttpParams,
  Z.Net.CrossHttpUtils,
  Z.Utils.Logger;
...
uses
  ...
  Winapi.Windows,
  {$ENDIF}
  Z.Utils.RegEx, Z.Utils.Utils,
  Z.Net.CrossHttpRouter;
...
begin
  ...
  LSender :=
    ...
    begin
      ...
      AConnection.SendBuf(Pointer(LData^), LCount, LSender);
    end;
