...
procedure TC40_FS3_Service.cmd_Create_File_From_MD5(Sender: TPeerIO; InData, OutData: TDFE);
var
  FileName_: U_String;
  Time__: TDateTime;
  Life_: Double;
...
procedure TC40_FS3_Service.cmd_End_Post(Sender: TPeerIO; InData, OutData: TDFE);
var
  io_define_: TC40_FS3_Service_RecvTunnel_NoAuth;
begin
  io_define_ := TC40_FS3_Service_RecvTunnel_NoAuth(Sender.UserDefine);
...
procedure TC40_FS3_Service.cmd_Get_File(Sender: TPeerIO; InData, OutData: TDFE);
var
  FileName_: U_String;
...
procedure TC40_FS3_Service.do_Th_Get_File_List(thSender: THPC_Stream; ThInData, ThOutData: TDFE);
var
  filter_: U_String;
  Max_Num, i: Int64;
  d: TDFE;
...
procedure TC40_FS3_Service.cmd_Get_File_List(Sender: TPeerIO; InData, OutData: TDFE);
begin
...
procedure TC40_FS3_Client_Post_File_Bridge.Do_Result_End_Post(Sender: TPeerIO; Result_: TDFE);
begin
  Do_Done(true);
  DelayFreeObj(1.0, self);
end;
