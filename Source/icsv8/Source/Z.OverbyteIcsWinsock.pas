...
uses
  ...
  {$I Include\Z.OverbyteIcsWinsockTypes.inc}
{$ENDIF MSWINDOWS}
...
uses
    ...
    System.Text,
    Z.OverbyteIcsTypes;
    {$I Include\Z.OverbyteIcsDotNetSockTypes.inc}
{$ENDIF CLR}

implementation
{$IFDEF MSWINDOWS}
  {$I Include\Z.OverbyteIcsWinsockImpl.inc}
...
{$IFDEF CLR}
    {$I Include\Z.OverbyteIcsDotNetSockImpl.inc}
{$ENDIF}
