...
{$ENDIF}
    ...
    Z.OverbyteIcsCRC,        { angus V7.7 }
    Z.OverbyteIcsMD5,        { angus V7.7 }
    Z.OverbyteIcsUtils,
    Z.OverbyteIcsStreams;    { angus V7.7 }
...
begin
    Result := Z.OverbyteIcsUtils.IcsGetLocalTimeZoneBias;
end;
