...
{$ENDIF FPC}
  ...
  TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data = record
    Name: U_String;
    Num: Int64;
    Time_: TDateTime;
  end;

  TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data_array = array of TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data;

  TC40_NetDisk_Client_On_Usr_Get_NetDisk_File_ListC = procedure(sender: TC40_NetDisk_Client; Successed: Boolean; info: U_String; arry: TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data_array);
  TC40_NetDisk_Client_On_Usr_Get_NetDisk_File_ListM = procedure(sender: TC40_NetDisk_Client; Successed: Boolean; info: U_String; arry: TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data_array) of object;
{$IFDEF FPC}
  TC40_NetDisk_Client_On_Usr_Get_NetDisk_File_ListP = procedure(sender: TC40_NetDisk_Client; Successed: Boolean; info: U_String; arry: TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data_array) is nested;
{$ELSE FPC}
  TC40_NetDisk_Client_On_Usr_Get_NetDisk_File_ListP = reference to procedure(sender: TC40_NetDisk_Client; Successed: Boolean; info: U_String; arry: TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data_array);
{$ENDIF FPC}
...
{$ENDIF FPC}
  ...
  TC40_NetDisk_Client_On_Usr_Get_Share_Disk_File_ListC = procedure(sender: TC40_NetDisk_Client; Successed: Boolean; info: U_String; arry: TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data_array);
  TC40_NetDisk_Client_On_Usr_Get_Share_Disk_File_ListM = procedure(sender: TC40_NetDisk_Client; Successed: Boolean; info: U_String; arry: TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data_array) of object;
{$IFDEF FPC}
  TC40_NetDisk_Client_On_Usr_Get_Share_Disk_File_ListP = procedure(sender: TC40_NetDisk_Client; Successed: Boolean; info: U_String; arry: TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data_array) is nested;
{$ELSE FPC}
  TC40_NetDisk_Client_On_Usr_Get_Share_Disk_File_ListP = reference to procedure(sender: TC40_NetDisk_Client; Successed: Boolean; info: U_String; arry: TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data_array);
{$ENDIF FPC}
...
{$ENDIF FPC}
  ...
  TC40_NetDisk_Client_On_Usr_Auto_Post_FileC = procedure(sender: TC40_NetDisk_Client; stream: TCore_Stream; Successed: Boolean; info: U_String);
  TC40_NetDisk_Client_On_Usr_Auto_Post_FileM = procedure(sender: TC40_NetDisk_Client; stream: TCore_Stream; Successed: Boolean; info: U_String) of object;
{$IFDEF FPC}
  TC40_NetDisk_Client_On_Usr_Auto_Post_FileP = procedure(sender: TC40_NetDisk_Client; stream: TCore_Stream; Successed: Boolean; info: U_String) is nested;
{$ELSE FPC}
  TC40_NetDisk_Client_On_Usr_Auto_Post_FileP = reference to procedure(sender: TC40_NetDisk_Client; stream: TCore_Stream; Successed: Boolean; info: U_String);
{$ENDIF FPC}
  ...
  TC40_NetDisk_Client_On_Usr_Auto_Get_FileC = procedure(sender: TC40_NetDisk_Client; stream: TCore_Stream; Successed: Boolean; info: U_String);
  TC40_NetDisk_Client_On_Usr_Auto_Get_FileM = procedure(sender: TC40_NetDisk_Client; stream: TCore_Stream; Successed: Boolean; info: U_String) of object;
{$IFDEF FPC}
  TC40_NetDisk_Client_On_Usr_Auto_Get_FileP = procedure(sender: TC40_NetDisk_Client; stream: TCore_Stream; Successed: Boolean; info: U_String) is nested;
{$ELSE FPC}
  TC40_NetDisk_Client_On_Usr_Auto_Get_FileP = reference to procedure(sender: TC40_NetDisk_Client; stream: TCore_Stream; Successed: Boolean; info: U_String);
{$ENDIF FPC}
  ...
  TC40_NetDisk_Client_Task = class
  private
    Pool_Ptr: TC40_NetDisk_Client_Task_Pool_Decl.PQueueStruct;
  public
    Client: TC40_NetDisk_Client;
    OwnerPool: TC40_NetDisk_Client_Task_Pool;
    Run_Task_Busy: Boolean;
    constructor Create;
    destructor Destroy; override;
...
{$ENDREGION 'event'}
  ...
  I_C40_NetDisk_Client_Event = interface
    ...
    procedure Do_Auto_Post_State(sender: TC40_NetDisk_Client; stream: TCore_Stream; Completed, Total: Int64);
    procedure Do_Auto_Get_State(sender: TC40_NetDisk_Client; stream: TCore_Stream; Completed, Total: Int64);
  end;
  ...
  public
    ...
    procedure RegC(userName_, Passwd_: U_String; OnResult: TC40_NetDisk_Client_On_Usr_RegC);
    procedure RegM(userName_, Passwd_: U_String; OnResult: TC40_NetDisk_Client_On_Usr_RegM);
    procedure RegP(userName_, Passwd_: U_String; OnResult: TC40_NetDisk_Client_On_Usr_RegP);
    ...
    procedure Build_Share_Disk_C(OnResult: TC40_NetDisk_Client_On_Usr_Build_Share_DiskC);
    procedure Build_Share_Disk_M(OnResult: TC40_NetDisk_Client_On_Usr_Build_Share_DiskM);
    procedure Build_Share_Disk_P(OnResult: TC40_NetDisk_Client_On_Usr_Build_Share_DiskP);
    ...
    // NetDisk Automated
    procedure Auto_Post_File_C(stream: TCore_Stream; Done_Free_Stream: Boolean; FileTime_: TDateTime; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Post_FileC);
    procedure Auto_Post_File_M(stream: TCore_Stream; Done_Free_Stream: Boolean; FileTime_: TDateTime; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Post_FileM);
    procedure Auto_Post_File_P(stream: TCore_Stream; Done_Free_Stream: Boolean; FileTime_: TDateTime; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Post_FileP);
    procedure Auto_Get_File_C(stream: TCore_Stream; Done_Free_Stream: Boolean; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileC);
    procedure Auto_Get_File_M(stream: TCore_Stream; Done_Free_Stream: Boolean; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileM);
    procedure Auto_Get_File_P(stream: TCore_Stream; Done_Free_Stream: Boolean; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileP);
    procedure Auto_Get_File_From_Share_Disk_C(stream: TCore_Stream; Done_Free_Stream: Boolean; Share_Directory_DB_Name, DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileC);
    procedure Auto_Get_File_From_Share_Disk_M(stream: TCore_Stream; Done_Free_Stream: Boolean; Share_Directory_DB_Name, DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileM);
    procedure Auto_Get_File_From_Share_Disk_P(stream: TCore_Stream; Done_Free_Stream: Boolean; Share_Directory_DB_Name, DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileP);
    // admin
...
var
  Successed: Boolean;
  info: U_String;
  arry: TC40_NetDisk_Client_On_Usr_NetDisk_FileList_Data_array;
  i: Integer;
begin
  Successed := Result_.R.ReadBool;
  info := '';
...
begin
  try
    if Assigned(OnResultC) then
        OnResultC(Client, stream, Successed, info);
    if Assigned(OnResultM) then
        OnResultM(Client, stream, Successed, info);
    if Assigned(OnResultP) then
        OnResultP(Client, stream, Successed, info);
  except
  end;
end;
  ...
  if Successed then
    begin
      ...
      if Assigned(Client.OnEvent) then
          Client.OnEvent.Do_Auto_Post_State(Client, stream, State_Completed, State_Total);
...
procedure TC40_NetDisk_Client_On_Usr_Auto_Post_File.Do_CheckAndCopy_NetDisk_File_Frag(sender: TC40_NetDisk_Client; Successed: Boolean; info: U_String);
begin
  if Successed then
    begin
...
procedure TC40_NetDisk_Client_On_Usr_Auto_Get_File.Do_Usr_Get_NetDisk_File_Frag_Info(sender: TC40_NetDisk_Client; Successed: Boolean; info: U_String; L: TDirectory_MD5_Data_Frag_Struct_List);
var
  i: Integer;
...
begin
  ...
  State_Completed := State_Total;
  if Assigned(Client.OnEvent) then
      Client.OnEvent.Do_Auto_Get_State(Client, stream, State_Completed, State_Total);
...
procedure TC40_NetDisk_Client_On_Usr_Auto_Get_File.Do_Get_NetDisk_File_Frag_MD5(sender: TC40_NetDisk_Client; Successed: Boolean; info: U_String; MD5: TMD5);
begin
...
constructor TC40_NetDisk_Client_Task_Pool.Create;
begin
  inherited Create;
...
begin
  ...
  task_.Pool_Ptr := Add(task_);
  task_.Client := Client;
  task_.OwnerPool := self;
end;

procedure TC40_NetDisk_Client_Task_Pool.Add_Task_Get_File(Client: TC40_NetDisk_Client; Local_File, DB_Field, DB_Item: U_String);
var
...
procedure TC40_NetDisk_Client_Task_Pool.Add_Task_Get_Share_File(Client: TC40_NetDisk_Client; Local_File, Share_Directory_DB_Name, DB_Field, DB_Item: U_String);
var
  task_: TC40_NetDisk_Client_Task_Auto_Get_File;
begin
  task_ := TC40_NetDisk_Client_Task_Auto_Get_File.Create;
...
procedure TC40_NetDisk_Client.RegC(userName_, Passwd_: U_String; OnResult: TC40_NetDisk_Client_On_Usr_RegC);
var
...
procedure TC40_NetDisk_Client.RegM(userName_, Passwd_: U_String; OnResult: TC40_NetDisk_Client_On_Usr_RegM);
var
  tmp: TC40_NetDisk_Client_On_Usr_Reg;
  d: TDFE;
begin
...
procedure TC40_NetDisk_Client.RegP(userName_, Passwd_: U_String; OnResult: TC40_NetDisk_Client_On_Usr_RegP);
var
  tmp: TC40_NetDisk_Client_On_Usr_Reg;
  d: TDFE;
begin
...
procedure TC40_NetDisk_Client.Build_Share_Disk_C(OnResult: TC40_NetDisk_Client_On_Usr_Build_Share_DiskC);
var
...
procedure TC40_NetDisk_Client.Build_Share_Disk_M(OnResult: TC40_NetDisk_Client_On_Usr_Build_Share_DiskM);
var
  tmp: TC40_NetDisk_Client_On_Usr_Build_Share_Disk;
  d: TDFE;
begin
...
procedure TC40_NetDisk_Client.Build_Share_Disk_P(OnResult: TC40_NetDisk_Client_On_Usr_Build_Share_DiskP);
var
  tmp: TC40_NetDisk_Client_On_Usr_Build_Share_Disk;
  d: TDFE;
begin
...
procedure TC40_NetDisk_Client.Auto_Post_File_C(stream: TCore_Stream; Done_Free_Stream: Boolean; FileTime_: TDateTime; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Post_FileC);
var
...
procedure TC40_NetDisk_Client.Auto_Post_File_M(stream: TCore_Stream; Done_Free_Stream: Boolean; FileTime_: TDateTime; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Post_FileM);
var
  tmp: TC40_NetDisk_Client_On_Usr_Auto_Post_File;
begin
  tmp := TC40_NetDisk_Client_On_Usr_Auto_Post_File.Create;
...
procedure TC40_NetDisk_Client.Auto_Post_File_P(stream: TCore_Stream; Done_Free_Stream: Boolean; FileTime_: TDateTime; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Post_FileP);
var
  tmp: TC40_NetDisk_Client_On_Usr_Auto_Post_File;
begin
  tmp := TC40_NetDisk_Client_On_Usr_Auto_Post_File.Create;
...
procedure TC40_NetDisk_Client.Auto_Get_File_C(stream: TCore_Stream; Done_Free_Stream: Boolean; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileC);
var
...
procedure TC40_NetDisk_Client.Auto_Get_File_M(stream: TCore_Stream; Done_Free_Stream: Boolean; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileM);
var
  tmp: TC40_NetDisk_Client_On_Usr_Auto_Get_File;
begin
  tmp := TC40_NetDisk_Client_On_Usr_Auto_Get_File.Create;
...
procedure TC40_NetDisk_Client.Auto_Get_File_P(stream: TCore_Stream; Done_Free_Stream: Boolean; DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileP);
var
  tmp: TC40_NetDisk_Client_On_Usr_Auto_Get_File;
begin
  tmp := TC40_NetDisk_Client_On_Usr_Auto_Get_File.Create;
...
procedure TC40_NetDisk_Client.Auto_Get_File_From_Share_Disk_C(stream: TCore_Stream; Done_Free_Stream: Boolean; Share_Directory_DB_Name, DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileC);
var
  tmp: TC40_NetDisk_Client_On_Usr_Auto_Get_File;
begin
  tmp := TC40_NetDisk_Client_On_Usr_Auto_Get_File.Create;
...
procedure TC40_NetDisk_Client.Auto_Get_File_From_Share_Disk_M(stream: TCore_Stream; Done_Free_Stream: Boolean; Share_Directory_DB_Name, DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileM);
var
  tmp: TC40_NetDisk_Client_On_Usr_Auto_Get_File;
begin
  tmp := TC40_NetDisk_Client_On_Usr_Auto_Get_File.Create;
...
procedure TC40_NetDisk_Client.Auto_Get_File_From_Share_Disk_P(stream: TCore_Stream; Done_Free_Stream: Boolean; Share_Directory_DB_Name, DB_Field, DB_Item: U_String; OnResult: TC40_NetDisk_Client_On_Usr_Auto_Get_FileP);
var
  tmp: TC40_NetDisk_Client_On_Usr_Auto_Get_File;
begin
  tmp := TC40_NetDisk_Client_On_Usr_Auto_Get_File.Create;
...
RegisterC40('NetDisk_C4', nil, TC40_NetDisk_Client);
