...
type
  TC40_TEKeyValue_VM_Service_Hash_Pool = {$IFDEF FPC}specialize {$ENDIF FPC}TGeneric_String_Object_Hash<TZDB2_HashTextEngine>;
...
begin
  ...
  TEKeyValue_Hash := TC40_TEKeyValue_VM_Service_Hash_Pool.Create(False,
