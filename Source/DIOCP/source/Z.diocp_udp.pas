...
uses
  Z.diocp_core_engine, Classes, SysUtils, Z.diocp_core_rawWinSocket,
  Z.diocp_winapi_winsock2, SyncObjs, Windows, Z.utils_locker, Z.utils_queues,
  Z.utils_hashs, Z.utils_safeLogger, Z.diocp_res;
...
type
  ...
  private
    ...
    FWSAToAddr: Z.diocp_winapi_winsock2.TSockAddrIn;
  ...
  private
    ...
    FWSARecvBuffer    : Z.diocp_winapi_winsock2.TWsaBuf;
    FWSARecvFrom      : Z.diocp_winapi_winsock2.TSockAddrIn;
    FWSAFromLen       : Integer;
  private
...
begin
  ...
  lvRet := Z.diocp_winapi_winsock2.WSARecvFrom(FListener.FRawSocket.SocketHandle,
     @FWSARecvBuffer,
     1,
...
begin
  ...
  FRequestState := rsPosting;
  lvRet := Z.diocp_winapi_winsock2.WSASendTo(FSocket,
     @FInnerBuffer,
     1,
     @lpNumberOfBytesRecvd,
     FWSASendFlag,
