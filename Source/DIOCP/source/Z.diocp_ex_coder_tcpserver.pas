 ...
 *)
unit Z.diocp_ex_coder_tcpserver;
...
uses
  Z.diocp_tcp_server, Z.utils_buffer, SysUtils, Classes,
  Z.diocp_coder_baseObject, Z.utils_queues, Z.utils_locker, Z.utils_BufferPool
...
type
  ...
  TIOCPCoderClientContext = class(Z.diocp_tcp_server.TIOCPClientContext)
  private
