...
unit Z.diocp_sockets_utils;

interface

uses
  Windows, SysUtils, Z.diocp_winapi_winsock2, Z.diocp_res;
...
begin
  ...
  Result := Z.diocp_winapi_winsock2.bind(s, PSockAddr(@sockaddr), SizeOf(sockaddr)) = 0;
end;
