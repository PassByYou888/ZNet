...
uses
  ...
  winsock, Z.diocp_winapi_winsock2,
...
{$ifend}
  ...
  Z.utils_threadinfo,
  {$ENDIF}
  Z.utils_queues, Z.utils_locker, Z.utils_async, Z.utils_fileWriter, Z.utils_strings, Z.utils_BufferPool;
...
{$ENDIF}
  begin
    ...
    lvRet := Z.diocp_winapi_winsock2.WSARecv(FContext.FRawSocket.SocketHandle,
       @FRecvBuffer,
       1,
