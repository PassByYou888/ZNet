...
uses
  Classes
  {$IFDEF POSIX}
  , Z.diocp_core_rawPosixSocket
  {$ELSE}
  , Z.diocp_core_rawWinSocket
  , Z.diocp_winapi_winsock2
  , SysConst
  {$ENDIF}
  , SysUtils, Z.utils_URL, Z.utils_strings, Z.diocp_ex_http_common, Z.utils_BufferPool;
