  ...
  object Memo1: TMemo
    ...
    Lines.Strings = (
      ...
      ''
        ...
        'The takeoff speed also indicates normal speed. The fill test is performed for the second time'
      'Calculation'
      'Copy operation does not require distinguishing between initial speed and takeoff speed'
      'This demo is a single line operation and only explains the basic library API. It cannot represent hardware capabilities. Do not use this demo to evaluate hardware'
      ''
      'by.qq600585'
      '')
