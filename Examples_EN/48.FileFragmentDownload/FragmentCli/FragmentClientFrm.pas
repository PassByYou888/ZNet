...
type
  ...
  private
    {  Automated P2PVM support technology is used here, please refer to the relevant demo for specific details  }
...
begin
  ...
  {  After the link is successful, AutomatedP2PVM will use the use of p2pVM handshake, which is triggered when all p2pVM handshakes are completed  }
...
begin
  ...
  {  1. First obtain the remote file size  }
  Session.First.logic.GetFileInfoP(demoFile, nil, nil,
    ...
    begin
      ...
      {  3. Calculate the MD5 of remote files to verify download correctness  }
