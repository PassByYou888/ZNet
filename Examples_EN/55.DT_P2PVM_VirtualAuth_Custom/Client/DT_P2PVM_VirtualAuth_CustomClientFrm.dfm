object DT_P2PVM_VirtualAuth_ClientForm: TDT_P2PVM_VirtualAuth_ClientForm
  ...
  object Memo: TMemo
    ...
    Lines.Strings = (
      ...
      '2. Try to use asynchronous events as much as possible in'
      '3. The VirtualAuth server accepts all login users and passwords'
      '4. Automation supports short line reconnection'
      ''
      'by.qq600585')
    ScrollBars = ssBoth
    TabOrder = 2
