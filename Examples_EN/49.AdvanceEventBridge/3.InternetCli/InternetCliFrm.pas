...
type
  ...
  {  The server can directly write instances, but it is best to encapsulate the client and develop a habit, otherwise maintenance will be difficult after the project pile is large  }
