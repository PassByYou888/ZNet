object AuthDoubleServerForm: TAuthDoubleServerForm
  ...
  object Memo1: TMemo
    ...
    Lines.Strings = (
      ...
      ''
      'Tunnel principle:'
      'VMTunnel is our tunnel server'
      'We trigger requests by intercepting the built-in tunnel of the server, and dynamically bind our Recv+Send channels in the request'
      ''
      ''
