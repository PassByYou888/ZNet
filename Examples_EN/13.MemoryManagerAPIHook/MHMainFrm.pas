...
begin
  {  2 million large batch record memory applications, final one-time release  }
...
begin
  ...
  Memo1.Lines.Add('123'); {  Because there is no previous or subsequent reference, neither Realloc nor GetMem will be recorded here  }
